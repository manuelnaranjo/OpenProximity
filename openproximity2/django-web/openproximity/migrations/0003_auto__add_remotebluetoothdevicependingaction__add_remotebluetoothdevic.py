...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RemoteBluetoothDevicePendingAction'
        db.create_table('openproximity_remotebluetoothdevicependingaction', (
        ...
        db.send_create_signal('openproximity', ['RemoteBluetoothDevicePendingAction'])

        # Adding model 'RemoteBluetoothDevicePairing'
        db.create_table('openproximity_remotebluetoothdevicepairing', (
            ('remotebluetoothdevicerecord_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['openproximity.RemoteBluetoothDeviceRecord'], unique=True, primary_key=True)),
            ('state', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('openproximity', ['RemoteBluetoothDevicePairing'])


    def backwards(self, orm):
        
        # Deleting model 'RemoteBluetoothDevicePendingAction'
        db.delete_table('openproximity_remotebluetoothdevicependingaction')

        # Deleting model 'RemoteBluetoothDevicePairing'
        db.delete_table('openproximity_remotebluetoothdevicepairing')
